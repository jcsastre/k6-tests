...
execution: local
    ...
    data_sent..................: 22 kB   732 B/s
    http_req_blocked...........: avg=68.69µs   min=3.74µs   med=9.64µs   max=1.85ms  p(90)=13µs    p(95)=448.3µs 
    http_req_connecting........: avg=56.68µs   min=0s       med=0s       max=1.79ms  p(90)=0s      p(95)=413.61µs
    http_req_duration..........: avg=890.28ms  min=193.67ms med=947.2ms  max=1.72s   p(90)=1.36s   p(95)=1.56s   
    http_req_receiving.........: avg=1.98ms    min=58.55µs  med=915.42µs max=43.24ms p(90)=4.07ms  p(95)=6.98ms  
    http_req_sending...........: avg=53.5µs    min=14.77µs  med=38.99µs  max=1.07ms  p(90)=59.23µs p(95)=80.39µs 
    http_req_tls_handshaking...: avg=0s        min=0s       med=0s       max=0s      p(90)=0s      p(95)=0s      
    http_req_waiting...........: avg=888.23ms  min=193.16ms med=947.05ms max=1.72s   p(90)=1.35s   p(95)=1.56s   
    http_reqs..................: 159     5.299749/s
    iteration_duration.........: avg=1.91s     min=1.19s    med=1.97s    max=2.73s   p(90)=2.37s   p(95)=2.59s   
    iterations.................: 154     5.13309/s
    uptos_count................: avg=82.459119 min=35       med=84       max=106     p(90)=97      p(95)=99.2    
